...
5. **Merging**  
Merging transcript assemblies (`.gtf` files) from IsoQuant and StringTie using IsoMatch to generate a unified, annotated `.GTF` file and requantifying using IsoQuant.
Example command:  
`./snakemake.sh default --until merge`  
